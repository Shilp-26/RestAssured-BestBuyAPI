...
public class ExtractionExamples {
    ...
    public void test003() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The fifth store name is : " + name);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test004() {
        List<String> storeList = response.extract().path("data.name");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The name of all the stores are : " + storeList);
        System.out.println("------------------End of Test---------------------------");
    ...
    @Test
    public void test005() {
        List<String> storeIdList = response.extract().path("data.id");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The storeID of all the stores are : " + storeIdList);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test008() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The address of store name 'Rochester' is : " + storeName);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test010() {
        List<String> services = response.extract().path("data.findAll{it.name='Windows Store'}.services");
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The stores services where service name = Windows Store: " + services);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test011() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The prices of products whose name end with = Vehicles are: " + storeId);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test012() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The id of product whose name 'Energizer - N Cell E90 Batteries (2-Pack)' is : " + id); //id.get(0)
        System.out.println("------------------End of Test---------------------------");
    }
